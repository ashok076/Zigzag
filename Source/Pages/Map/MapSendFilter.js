...
import { filter } from './Modal/mapData';
...
export default class MapSendFilter extends Component {
    initialState = {
        visible: false
    }
    constructor(props) {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.searchBox}>
                    <TouchableOpacity onPress={() => this.setState({visible:true})}>
                        <Feather name="filter" color="#5b57ba" size={24} />
                    </TouchableOpacity>
                </View>
                {
                        ...
                        >
                            <View style={styles.card}>
                                <ScrollView style={styles.textContent}>
                                    <Text numberOfLines={2} style={styles.cardtitle}>Filter</Text>
                                    ...
                                    <Card style={{ marginTop: '5%', width: '100%' }}>
                                        <View style={{ flexDirection: 'row', justifyContent: 'space-around' }} onPress={() => this.setState({ visible: true })}>
                                            <TouchableOpacity onPress={()=>navigation.navigate("FindingPilot")} style={{ padding: '5%', borderWidth: 1, borderColor: '#00000014', borderRadius: 15 }}>
                                                <Image
                                            ...
                                            <TouchableOpacity onPress={()=>navigation.navigate("FindingPilot")}  style={{ padding: '5%', borderWidth: 1, borderColor: '#00000014', borderRadius: 15 }} onPress={() => this.setState({ visible: true })}>
                                                <Image
                                    ...
                                    <View style={{ flexDirection: "row", width: '100%', marginTop: "5%", marginBottom: '3%' }}>
                                        ...
                                        <View style={{ width: '80%', alignSelf: 'center', }}>
                                            <Text numberOfLines={1} style={styles.cardPickupTimeView}>Any</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={{ flexDirection: "row", width: '100%', }}>
                                        ...
                                        <View style={{ width: '80%', alignSelf: 'center', }}>
                                            <Text numberOfLines={1} style={styles.cardPickupL1View}>20Km from me</Text>
                                        </View>
                                    </View>
                                    <View style={{ borderWidth: 1, borderColor: '#00000014', width: '80%', alignSelf: 'flex-end' }} />
                                    <View style={{ flexDirection: "row", width: '100%', }}>
                                        ...
                                        <View style={{ width: '80%', alignSelf: 'center', }}>
                                            <Text style={styles.cardPickupL2View}>Munich</Text>
                                        </View>
                                    </View>
                                    <View style={{ borderWidth: 1, borderColor: '#00000014', width: '100%' }} />
                                    <Card style={{ margin: '5%', backgroundColor: '#EEEEEE' }}>
