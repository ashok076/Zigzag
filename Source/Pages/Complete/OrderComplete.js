    ...
    render() {
        ...
        return (
            <SafeAreaView style={{ flex: 1, backgroundColor: '#746FCA' }}>
                <ScrollView>
                <View style={{ alignSelf: 'center', margin: '15%',alignSelf:'center',marginLeft:'35%' }}>
                    <Image
                ...
                <View style={{ marginLeft: '5%',alignSelf:'center' }}>
                    <Text style={{ fontSize: 30, fontFamily: 'Manrope-Bold',color:'#ffffff'  }}>Order Created</Text>
                </View>
                <View style={{ marginTop: '5%', marginLeft: '5%',alignSelf:'center' }}>
                    <Text style={{ fontSize: 16, fontFamily: 'Manrope-Regular', color:'#ffffff' }}>You will be notified when a pilot is found</Text>
                </View>
